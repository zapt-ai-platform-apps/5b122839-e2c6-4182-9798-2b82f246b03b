  ...
  const steps = [
    {
      ...
      description: 'Fill out a simple form with your ticket and vehicle information',
      icon: (
    ...
    },
    {
      ...
      description: 'Make a secure one-time payment to generate your letter',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      id: 3,
      title: 'Get Your Professional Letter',
      description: 'Receive a tailored dispute letter with legal arguments',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Send the letter to the issuing authority and challenge your ticket',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
